      ...
      <ScrollView>
        <View style={styles.section}>
          ...
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>
              Pairfect is a Match Making application designed to help you find meaningful connections. Our intelligent matching system helps you discover people who share your interests and values.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.navItem}>
            <View style={[styles.navIcon, { backgroundColor: '#FFE8E8' }]}>
              <Ionicons name="flame" size={24} color="#FF6B6B" />
            </View>
            <View style={styles.navTextContainer}>
              <Text style={styles.navTitle}>Discover & Swipe</Text>
              <Text style={styles.navDescription}>
                Swipe right to like or left to pass on profiles in your area
              </Text>
            </View>
          </View>
          ...
          <View style={styles.navItem}>
            ...
            <View style={styles.navTextContainer}>
              ...
              <Text style={styles.navDescription}>
                View your current matches and connections
              </Text>
            </View>
          </View>
          ...
          <View style={styles.navItem}>
            ...
            <View style={styles.navTextContainer}>
              ...
              <Text style={styles.navDescription}>
                Edit your profile and adjust settings
              </Text>
            </View>
          </View>
        </View>
